...
project = 'ishockpy'
copyright = '2017, J. Michael Burgess, Damein Begue'
...
rtds_action_github_repo = "grburgess/ishockpy"
...
latex_documents = [
    (master_doc, 'ishockpy.tex', u'ishockpy Documentation',
...
man_pages = [(master_doc, 'ishockpy', u'ishockpy Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'ishockpy', u'ishockpy Documentation', author, 'ishockpy',
